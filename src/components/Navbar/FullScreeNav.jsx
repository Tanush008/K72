...
// import NavContext, { NavabarContex } from '../context/NavContext'
import gsap from 'gsap'
import { NavbarContext } from '../../context/NavContext'

const FullScreeNav = () => {
    const fullScreeRef = useRef(null)
    const fulllScreenLinkRef = useRef(null)
    const [navOpen, setNavOpen] = useContext(NavbarContext)
    // const [navLink, setNavLink] = useContext(NavbarColorContext)
    ...
    return (
        <div ref={fullScreeRef} className='fullscreen hidden text-white overflow-hidden h-screen w-full z-50 absolute'>
            ...
            <div ref={fulllScreenLinkRef} className='relative'>
                <div className='navlink flex w-full justify-between items-start'>
                    ...
                    <div onClick={() => {
                        setNavOpen(false)
                    }} className='lg:h-32 h-18 w-18 lg:w-32 relative cursor-pointer'>
                        <div className='lg:h-42 h-28 lg:w-1 w-0.5 -rotate-45 origin-top absolute bg-[#D3FD50]'></div>
                        <div className='lg:h-42 h-28 lg:w-1 w-0.5 right-0 rotate-45 origin-top absolute bg-[#D3FD50]'></div>
                    </div>
                </div>

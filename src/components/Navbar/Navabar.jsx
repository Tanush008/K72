...
const Navabar = () => {
    ...
    return (
        <div className='w-full z-4  absolute top-0 flex items-start justify-between'>
            <div className='p-2'>
                <div className='w-36'>
            ...
            <div onClick={() => {
                ...
                onMouseEnter={() => {
                    navRef.current.style.heigth = '100%'
                }}
                onMouseLeave={() => {
                    navRef.current.style.heigth = '0%'
                }}
                className='bg-black relative w-48 h-8'>

                <div className='absolute top-0 transition-all w-full h-0'>
                    <div ref={navRef} className='relative h-full lg:px-12 px-8 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
                    </div>

...
const HomeBottom = () => {
    return (
        <>
            <div className='flex items-center font-[font2] justify-center gap-2 '>
                ...
                <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-42 flex items-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase'>
                    <Link className='text-[5.5vw] lg:mt-4' to='/projects'>Projects</Link>
                </div>
                <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50]  lg:h-42 flex items-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase'>
                    <Link className='text-[5.5vw] lg:mt-4' to='/agence'>agence</Link>
                </div>
            </div>
        </>
    )
